from report.DataframeReport import DataframeReport, DataframeReportComparison
...
def test_dataframe_report_comparison():
    ...
    comparison = DataframeReportComparison(original_report, modified_report)
    alerts = comparison.get_alerts(default_percentage_threshold=0.1)
